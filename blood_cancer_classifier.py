...
# Create a Prometheus counter to track the number of image classifications
classify_counter = Counter('image_classifications_total', 'Total number of image classifications')
